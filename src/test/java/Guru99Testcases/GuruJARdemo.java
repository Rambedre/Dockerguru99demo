...
//        driver.switchTo().parentFrame();
        ...
        Customer_ID = driver.findElement(By.xpath("//b[text()='Customer ID']/parent::td/following-sibling::td[@align='center']/child::h3"))
                .getText();
    ...
    public void addTariffPlan() {
        ...
        driver.findElement(By.xpath("//input[@type='submit']")).click();
        String confirmation = driver.findElement(By.xpath("//h2[text()='Congratulation you add Tariff Plan']"))
                .getText();
    ...
    public void addTariffPlantoCustomer() {
        driver.findElement(By.xpath("//section[@id='one']/descendant::a[text()='Add Tariff Plan to Customer']"))
                .click();
        ...
        String AssignedPlan = driver.findElement(By.xpath("//h2[text()='Congratulation Tariff Plan assigned']"))
                .getText();
